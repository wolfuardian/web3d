...
//
//                         LIB.LoadGLBModel( object.userData.src, ( result ) => {
//
//                             if ( result ) {
//
...
//     inspect() {
//
//         this.cameraPositionParams.camera_x = this.camera.position.x.toFixed( 3 );
//         this.cameraPositionParams.camera_y = this.camera.position.y.toFixed( 3 );
//         this.cameraPositionParams.camera_z = this.camera.position.z.toFixed( 3 );
//
//     }
// }
//
